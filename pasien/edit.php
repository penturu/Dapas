                ...
                <form method="post">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-1 mr-none">
                            <input name="no_rm1" type="number" class="form-control" id="rekmed" value="<?php echo $noRm1; ?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="2" max="99" required>
                        </div>
                        <p>.</p>
                        <div class="col-sm-1">
                        ...
                        <p>.</p>
                        <div class="col-sm-1">
                            <input name="no_rm3" type="number" class="form-control" id="rekmed" value="<?php echo $noRm3; ?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="2" max="99" required>
                        </div>
                    </div>
                    <div class="row mb-3">
